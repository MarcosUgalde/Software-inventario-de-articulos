        ...
        {product.data ? (
            <>
                ...
                <form onSubmit={handleSubmit(doUpdateProduct)}>
                    ...
                    <input type="text" name="product_description" id="product_description" placeholder="Insert product description" {...register('product_description', {required: true})} defaultValue={product?.data[0].product_description} />
                    <input type="text" name="product_quantity" id="product_quantity" placeholder="Insert quantity provided" {...register('product_quantity', {required: true})} defaultValue={product?.data[0].product_quantity} />
